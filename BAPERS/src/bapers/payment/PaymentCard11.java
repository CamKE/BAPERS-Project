 ...
 * @author kelvin
 */
public class PaymentCard11 extends PaymentDetails {
    private final String cardType;
    private final String cardDetailsLast4digits;
    private final String cardDetailsExpiryDate;

    public PaymentCard11(int[] paymentNo, int[] invoiceNumber, double total, String paymentType, Date paymentDate, String cardType, String cardDetailsLast4digits, String cardDetailsExpiryDate) {
